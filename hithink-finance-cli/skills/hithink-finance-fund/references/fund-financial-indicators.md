...
- 执行前用 `hithink-finance schema fund.financial-indicators --format json` 确认当前参数契约。
...
hithink-finance fund financial-indicators --fund-type <type> --thscode <code> --format json
```
