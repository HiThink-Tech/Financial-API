...
- 执行前用 `hithink-finance schema fund.industry-allocation --format json` 确认当前参数契约。
...
hithink-finance fund industry-allocation --fund-type <type> --thscode <code> --format json
```
