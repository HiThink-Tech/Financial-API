...
| 需要最新/当天数据、集合竞价、财报、估值、指数、基金、特色数据或标的目录 | [`fuyao`](fuyao/README.md) |
...
用户可以把 Key 提供给 Agent 上下文完成代配；Agent 不复述，并提示聊天平台可能保留消息记录。不要把 Key 写入代码、日志、输出文件或提交。
