...
- 执行前用 `hithink-finance schema fund.stock-report-dates --format json` 确认当前参数契约。
...
hithink-finance fund stock-report-dates --fund-type <type> --thscode <code> --format json
```
