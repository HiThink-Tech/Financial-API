...
>
> 对应 REST 端点：[`GET /api/futures/positions/company-variety-daily`](../../api/futures/futures-positions.md#positions-company-variety-daily--positions-company-variety-daily)
